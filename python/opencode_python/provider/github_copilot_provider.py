        ...
        return ProviderInfo(
            ...
            models=[
                ...
                ModelInfo(
                    ...
                    description="GitHub Copilot's Claude 3.5 Sonnet model",
                ...
                ModelInfo(
                    ...
                    description="GitHub Copilot's Claude 3.7 Sonnet model",
                    context_length=200000,
                    supports_tools=True,
                ...
                ModelInfo(
                    ...
                    name="Claude 3.7 Sonnet Thought (Copilot)",
                    description="GitHub Copilot's Claude 3.7 Sonnet with thinking model",
                    context_length=200000,
                    supports_tools=True,
                    cost_per_input_token=0.0,
                    cost_per_output_token=0.0,
                ...
                ModelInfo(
                    ...
                    description="GitHub Copilot's Claude Sonnet 4 model",
                    context_length=200000,
                    supports_tools=True,
                    cost_per_input_token=0.0,
                    cost_per_output_token=0.0,
                ...
                ModelInfo(
                    ...
                    description="GitHub Copilot's Gemini 2.0 Flash model",
                ...
                ModelInfo(
                    ...
                    description="GitHub Copilot's Gemini 2.5 Pro model",
                ...
                ModelInfo(
                    ...
                    description="GitHub Copilot's GPT-4.1 model",
                ...
                ModelInfo(
                    id="o1",
                    name="o1 (Copilot)",
                    description="GitHub Copilot's o1 model",
                    context_length=200000,
                ...
                ModelInfo(
                    ...
                    description="GitHub Copilot's o3 mini model",
                    context_length=128000,
                ...
                ModelInfo(
                    ...
                    description="GitHub Copilot's o4 mini model",
                    context_length=128000,
                    supports_tools=False,
                    cost_per_input_token=0.0,
                    cost_per_output_token=0.0,
